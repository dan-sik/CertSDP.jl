...
const GATE_SPECS = GateSpec[
    ...
    GateSpec(:G, "Primal-dual/Farkas",
             ...
             ["primal_dual_optimality.jl", "farkas_certificate.jl",
              ...
              "test_primal_dual_no_lhs_rhs_fallback.jl",
              "test_primal_dual_affine_operator_replay.jl",
              "test_farkas_no_lhs_rhs_fallback.jl",
              "test_farkas_problem_data_replay.jl"],
    ...
    GateSpec(:J, "NC/Quantum/NPA",
             ...
             ["nc_rewrite_witness.jl", "quantum_bound_certificate.jl",
              ...
              "test_npa_every_moment_entry_replay.jl",
              "test_npa_objective_from_verified_moments.jl",
              "test_npa_missing_entry_node_rejects.jl",
              "test_npa_wrong_entry_witness_rejects.jl",
              "test_quantum_relation_semantics.jl"],
    ...
    GateSpec(:L, "Number field/algebraic layer",
             ...
             ["field_layer.jl", "psd_low_rank_factor.jl",
              "test_cubic_field_sign_replay.jl",
              "test_cubic_field_sign_tamper_rejection.jl"],
    ...
    GateSpec(:Q, "Validation corpus",
             ...
             ["validation_cli_surface.jl",
              "test_true_external_raw_fixture_policy.jl",
              "test_true_external_raw_import_replay.jl",
              "test_true_external_raw_tamper_rejection.jl"],
             ["replay_valid", "replay_tamper"],
    ...
    GateSpec(:W, "Symmetry reduction",
             ...
             ["symmetry_reduction.jl",
              "test_symmetry_group_closure_semantics.jl",
              "test_symmetry_projector_idempotence.jl",
              "test_symmetry_projector_orthogonality.jl",
              "test_symmetry_projector_completeness.jl",
              "test_symmetry_block_transform_reconstruction.jl",
              "test_symmetry_psd_transfer_theorem.jl"],
             ["replay_valid", "replay_tamper"],
             ["block_reconstruction"], [:verify_block_diagonalization_certificate], true),
    GateSpec(:X, "Paper bundle",
             ["psd_factor_rational_150"], ["psd_factor_rational_150/tampered_negative_diagonal.json"],
             ["paper_bundle.jl",
              "test_bundle_full_offline_verify.jl",
              "test_bundle_non_placeholder_problem.jl",
              "test_bundle_source_artifact_tamper.jl",
              "test_bundle_object_store_tamper.jl",
              "test_bundle_theorem_statement_tamper.jl",
              "test_bundle_extra_untracked_proof_file_rejects.jl"],
             ["bundle_verify"], ["offline_bundle_replay"],
             [:verify_certificate], false),
    ...
    GateSpec(:Z, "Release audit",
             ["psd_factor_rational_150"], ["psd_factor_rational_150/tampered_negative_diagonal.json"],
             ["test_release_audit.jl",
              "test_pass10_no_active_score_caps.jl",
              "test_pass10_audit_report_evidence.jl"],
             ["audit_strict_full"], ["audit_report", "gate_scores"],
             [:verify_certificate], false),
